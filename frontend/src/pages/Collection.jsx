...
const Collection = () => {
  ...
  return (
    <div className='flex flex-col sm:flex-row gap-10 border-t py-5'>
      ...
      <div className='min-w-60'>
        ...
        {/* Category filter */}
        <div
          className={`border border-gray-300 pl-5 py-3 mt-6 my-5 ${showFilter ? '' : 'hidden'
            }`}
        >
          ...
          <div className='flex flex-col gap-2 text-sm font-light text-gray-700'>
            ...
            <p onChange={toggleCategory} className='flex gap-2'>
